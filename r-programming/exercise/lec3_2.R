...
setwd("C:/Users/uvent/source/repos/r-programming/exercise")
...
# subset with wt<1300
brain1300f<-subset(brain,wt<1300 & sex=='f')
...
write.table(brain1300f,file="brain1300f.csv", row.names = FALSE, sep=",", na=" ")

write.csv(brain1300f,file="brain1300f.csv", row.names = FALSE)
