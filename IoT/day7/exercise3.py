...
face_cascade = cv2.CascadeClassifier('cascadesdatahaarcascade_frontalface_alt2.xml')
eye_cascade = cv2.CascadeClassifier('cascadesdatahaarcascade_eye.xml')
smile_cascade = cv2.CascadeClassifier('cascadesdatahaarcascade_smile.xml')
...
while (True)
    ...
    for (x, y, w, h) in faces
        # print(x,y,w,h)
        roi_gray = gray[yy + h, xx + w]  # (ycord_start, ycord_end)
